namespace Terrasoft.Core.Process
{
	...
	#region Class: YangCaclAveragePriceProcessMethodsWrapper

	/// <exclude/>
	public class YangCaclAveragePriceProcessMethodsWrapper : ProcessModel
	{

		public YangCaclAveragePriceProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
				...
				var priceColumn = esq.AddColumn("YangPriceUSD");  // select UsPriceUSD as UsrPriceUSD, UsrAreaSqM as UsrAreaSqM from UsrRealty where ...
				...
				var offerTypeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "YangRealtyOfferType", offerTypeId);
